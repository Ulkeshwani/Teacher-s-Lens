...
import OrganisationContent from "Components/Content/OrganisationContent";
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "100vh" }}>
      ...
      <Box sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
        <Header onDrawerToggle={handleDrawerToggle} title="Organisations" />
        <Box
          component="main"
          sx={{ flex: 1, py: 6, px: 4, bgcolor: "#eaeff1" }}
        >
          <OrganisationContent formikProps={formik} />
        </Box>
